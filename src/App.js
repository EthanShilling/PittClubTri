...
import Milestone7 from "./wetsuit.png";
import Milestone8 from "./amongus.png";
import Milestone9 from "./8hourarmworkout.jpg";
...
function App() {
  ...
  const mDesc = [
    ...
    "Jinwoo wears a wetsuit, goggles, and swim cap for a school day",
    "Brandon runs a half marathon in an inflatable Among Us costume",
    "Pier and Matt do Rich Piana's 8 hour arm workout",
    "to be determined",
    "to be determined",
  ];
// Milestone Images
